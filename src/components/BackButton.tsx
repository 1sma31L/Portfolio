...
export default function Page() {
	...
	return (
		<button type="button" onClick={() => router.back()}>
			<span className="flex justify-start items-center text-zinc-400 hover:text-black transition-colors duration-150 dark:text-zinc-500 dark:hover:text-white group mb-3 ">
