...
export default function NavBar() {
	...
	return (
		<>
			{!clicked && (
				<>
					<div className="w-full max-w-[1600px] mx-auto  dark:bg-zinc-950 flex justify-between md:justify-around items-center text-[9px] sm:text-[11px] md:text-sm dark:text-white py-2 px-4 gap-4">
