...
function InfiniteScroll({ icons }: { icons: TItem[] }) {
  ...
  before:bg-[linear-gradient(to_right,theme(colors.zinc.50)_0%,rgba(255,255,255,0)_100%)] 
  dark:before:bg-[linear-gradient(to_right,theme(colors.zinc.950)_0%,rgba(0,0,0,0)_100%)] 
  before:content-[''] 
