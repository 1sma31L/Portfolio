...
3. [3. HTML Basics](#3-html-basics)
   1. [3.1 HTML Elements Cheat-sheet](#31-html-elements-cheat-sheet)
   2. [3.2. Working With Text And Formatting](#32-working-with-text-and-formatting)
      1. [3.2.1 Bold And Italic](#321-bold-and-italic)
      2. [3.2.2 Heading And Paragraph](#322-heading-and-paragraph)
      3. [3.2.3 Paragraph](#323-paragraph)
      4. [3.2.4 Span](#324-span)
      5. [3.2.4 List](#324-list)
   3. [3.3 Text Spearators](#33-text-spearators)
   ...
   9. [3.9 From handling](#39-from-handling)
      1. [3.9.1 Input](#391-input)
      2. [3.9.2 Button](#392-button)
      3. [3.9.3 Form](#393-form)
   10. [3.10 Div And Semantic HTML](#310-div-and-semantic-html)
...
## 3.3 Text Spearators
`<br>` tag is used to insert a line break in the text.
`<hr>` tag is used to insert a horizontal rule (line) in the document.
```html showLineNumbers {8-10}
<!DOCTYPE html>
<html>
<head>
    <title>Title</title>
